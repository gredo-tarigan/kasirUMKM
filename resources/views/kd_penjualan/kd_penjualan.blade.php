                    ...
                    <tbody>
                        ...
                        <tr class="text-center">
                            ...
                            <td style="white-space: nowrap;" class="text-center">
                                <a class="btn btn-primary btn-sm d-none d-sm-inline-block" role="button" href="sales/edit/{{ $dsd_kdPenjualan->slug }}" ><i class="fa fa-pencil-square-o fa-sm text-white-50"></i>&nbsp;Edit</a>                                    
